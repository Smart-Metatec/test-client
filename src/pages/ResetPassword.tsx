...
const ResetPassword = () => {
    ...
    const updatePasswordVisibility = (password: any) => {
        if(password === 1){
    ...
    const verify = (password1: string, password2: string) => {
    ...
    const submit = async () => {
        ...
        if(validPasswords){
            ...
            try {
                const requestReset = await axios.post("/api/users/resetpassword", {id, password: password1 })
